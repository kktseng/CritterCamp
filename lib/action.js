...
exports.joinGroup = function(username, message, callback) {
  if(!message.game) {
    return users.messageUser(username, 'You need to specify a game stupid.', callback);
  }
...
exports.inviteParty = function(username, message, callback) {
  if(!message.user) {
    return users.messageUser(username, 'You need to choose someone to invite downy.');
  }
...
exports.acceptParty = function(username, message, callback) {
  if(!message.user) {
    return users.messageUser(username, 'You didnt specify whos party genius.', callback);
  }
...
exports.rejectParty = function(username, message, callback) {
  if(!message.user) {
    return users.messageUser(username, 'Who you rejecting bro?');
  }
...
exports.removeParty = function(username, message, callback) {
  if(!message.user) {
    return users.messageUser(username, 'Who you removing brah?');
  }

        ...
        if(isFull) {
          ...
          async.waterfall([
            ...
            function(user_list, user_info, callback) {
              helpers.redis.hget('user_' + username, version, function(err, min_version) {
                callback(err, user_list, user_info, min_version);
              });
            },
            function(user_list, user_info, min_version, callback) {
              group.selectGames(min_version, function(err, selected_games) {
